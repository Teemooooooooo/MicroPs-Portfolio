...
The waveform simulation and test results of the flash LED module (flash_led) is shown in @fig-sim_counter_tests and @fig-sim_counter_max. This testbench cover the reset behavior, enable behavior, and the behavior at counter maximum threshold. The DUT exhibit expected behavior for all test cases. 
