...
![Waveform simulation of counter module at maximum counter behavior](images/counter1){#fig-sim_counter_max}

![Waveform simulation including counter at maximum counter behavior](images/counter_sim){#fig-sim_counter}
:::

The waveform simulation and test results of the flash LED module (flash_led) is shown in @fig-sim_counter_tests, @fig-sim_counter and @fig-sim_counter_max. This testbench cover the reset behavior, enable behavior, and the behavior at counter maximum threshold. The DUT exhibit expected behavior for all test cases. 
